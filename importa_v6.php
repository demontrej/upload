...
foreach($listado_productos as $producto)
{
    ...
    {   
        ...
        //busca el precio en archivo de precios según el sku
        ...
        if($productomagento['description']!=  utf8_encode($producto[2])){$cambios[]='decripción';}
        if($productomagento['short_description']!=  utf8_encode($producto[1])){$cambios[]='decripción corta';}
        ...
        //si tiene algún cambio actuliza
        if(count($cambios)>0){
